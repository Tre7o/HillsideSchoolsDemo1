...
class FeesStructureFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_fees_structure, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val webView = view.findViewById<WebView>(R.id.web_fees)
        ...
        webView.loadUrl("https://www.hillsideschoolsnaalya.com/fees-structure/")
