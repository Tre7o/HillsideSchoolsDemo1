...
class CoordinatorsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val webView = view.findViewById<WebView>(R.id.web_coordinators)
        ...
        webView.loadUrl("https://www.hillsideschoolsnaalya.com/primary-school-coordinators/")
